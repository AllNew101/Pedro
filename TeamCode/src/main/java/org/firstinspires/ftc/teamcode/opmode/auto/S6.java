...
//        myColorBlobLocatorProcessorBuilder.setTargetColorRange(new ColorRange(ColorSpace.RGB, new Scalar(30, 30, 10), new Scalar(200, 255, 25)));
    ...
    public void track() throws InterruptedException {
        ...
        while ((System.currentTimeMillis() - time2) <= 50) {
        ...
        telemetry.addData("Array", data_right );
        telemetry.update();
        Thread.sleep(50);
        ...
        if (JavaUtil.listLength(data_right) != 0) {
            ...
            if ((Long)JavaUtil.inListGet((((List) JavaUtil.inListGet(data_right, JavaUtil.AtMode.FROM_START, (int) 0, false))), JavaUtil.AtMode.FROM_START, (int) 0, false) <= 50) {
                Servo_kan(0);
                Thread.sleep(1000);
                neep.setPosition(1);
                Thread.sleep(1000);
