...
public class FollowerConstants {
    ...
    private static double xMovement = 64.02;
    private static double yMovement = 52.07;
    ...
    public static double mass = 12.00000;
    ...
    public static double forwardZeroPowerAcceleration = -41.4081;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -66.8081;
