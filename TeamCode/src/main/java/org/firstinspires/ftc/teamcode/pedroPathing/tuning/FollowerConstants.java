...
public class FollowerConstants {
    ...
    private static double xMovement = 44.3876;
    private static double yMovement = 34.6415;
    ...
    public static double mass = 13.00000;
    ...
    public static double forwardZeroPowerAcceleration = -29.2369;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -51.0399;
